    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch('http://127.0.0.1:3000/api/v1/users/logout', {
            method: "GET"
          });
        case 3:
          ...
          if (_response.ok) {
            ...
            (0, _alerts.showAlert)('error', _response.statusText);
          }
          _context.next = 10;
          break;
        case 7:
          ...
          (0, _alerts.showAlert)('error', response.sattusText);
        case 10:
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (_response2.ok) {
            ...
            (0, _alerts.showAlert)('error', _response2.statusText);
          }
          _context2.next = 10;
          break;
        case 7:
...
var updateData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(dataToUpdate, formType) {
    var urlEndpoint, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          urlEndpoint = formType === "password" ? "/updateMyPassword" : "/updateMe";
          console.log(dataToUpdate);
          console.log(formType);
          console.log(urlEndpoint);
          _context.prev = 4;
          _context.next = 7;
          return fetch("http://127.0.0.1:3000/api/v1/users".concat(urlEndpoint), {
            method: "PATCH",
            headers: {
              'Content-Type': 'application/json;charset=utf-8'
            },
        ...
        case 7:
          ...
          if (response.ok) {
            ...
            (0, _alerts.showAlert)('error', response.statusText);
          }
          _context.next = 14;
          break;
        case 11:
...
var passwordUpdateForm = document.querySelector('.form-user-password');
var logOutButton = document.querySelector('.nav__el--logout');
var updateSettingsForm = document.querySelector(".js-update-account");
if (loginForm) {
...
if (passwordUpdateForm) {
  passwordUpdateForm.addEventListener('submit', /*#__PURE__*/function () {
